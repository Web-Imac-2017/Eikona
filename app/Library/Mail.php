...
<html>
	...
	<body>
		...
		<h3>Si le formulaire ne s'affiche pas correctement, <a href='localhost/Eikona/do/auth/activate?user_id=".$userID."&user_key=".sha1($time)."'>veuillez suivre ce lien.</a>
	</body>
