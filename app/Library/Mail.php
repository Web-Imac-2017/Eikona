...
<html>
	...
	<body>
		...
		<h3>Si le formulaire ne s'affiche pas correctement, <a href='localhost/Groupe1/app/do/auth/activate?user_id=".$id."&user_key=".sha1($time)."'>veuillez suivre ce lien.</a>
	</body>
